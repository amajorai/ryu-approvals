<p align="center">
  <picture>
    ...
    <img src="./icon-light.png" alt="Approvals" width="144" />
  </picture>
</p>
...
A human-in-the-loop queue where agent-proposed actions, edits, and fixes wait for your accept or reject before they take effect.
...
**App:** [Install](ryu://apps/@ryu/approvals) (opens the Ryu desktop app and asks you to confirm)

**CLI:**

```bash
ryu apps add @ryu/approvals
```
...
The notification section supports the same filter pills as the desktop tray: **All**,
**Unread**, **Archived**, and one pill per notification level. Archived rows are
marked read and can be restored from **Archived** or **All**.
...
<a href="https://github.com/amajorai/ryu-approvals/stargazers">
  <picture>
